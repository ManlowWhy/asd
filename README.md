...
El proyecto está compuesto por dos programas principales.

### `generator`

Programa encargado de generar archivos binarios con números enteros aleatorios.

### `sorter`

Programa encargado de ordenar archivos binarios utilizando la clase `PagedArray`, sin modificar el archivo original de entrada. El archivo primero se copia a una ruta de salida y sobre esa copia se realiza el ordenamiento.

Además, al finalizar la ejecución, `sorter` genera una versión en texto del archivo ordenado para facilitar la verificación de correctitud.
...
terminal o consola
permisos de lectura y escritura sobre los archivos utilizados
Compilación
